...
const mockSharedKeys: SharedAPIKey[] = [
  { id: 'sk-1', name: 'Team OpenAI Key', provider: 'openai', key: 'sk-proj-xxxxxx', prefix: 'sk-proj-xxx', rateLimit: 60, rateLimitWindow: 300, isActive: true, assignedTo: ['all'], createdAt: '2026-03-01', usageCount: 1247 },
  { id: 'sk-2', name: 'Dev Anthropic', provider: 'anthropic', key: 'sk-ant-xxxxxx', prefix: 'sk-ant-xxx', rateLimit: 30, rateLimitWindow: 300, isActive: true, assignedTo: ['user-2'], createdAt: '2026-03-10', usageCount: 342 },
]

const mockServers: ServerConnection[] = [
  { id: 'srv-1', name: 'Production OpenAI', type: 'openai', baseURL: 'https://api.openai.com/v1', apiKey: 'sk-proj-xxx', prefix: 'sk-proj-', rateLimit: 60, rateLimitWindow: 300, isActive: true, isConnected: true, lastChecked: '2min ago', health: 'healthy', assignedTo: ['all'] },
  { id: 'srv-2', name: 'Custom LLM Server', type: 'custom', baseURL: 'https://llm.company.com/v1', apiKey: 'sk-custom-xxx', prefix: 'sk-custom-', rateLimit: 100, rateLimitWindow: 300, isActive: true, isConnected: false, lastChecked: '15min ago', health: 'offline', assignedTo: ['all'] },
]

const mockRateLimitTiers: RateLimitConfig[] = [
  { id: 'tier-1', name: 'Free', tier: 'free', maxCalls: 20, windowSeconds: 300, maxTokens: 100000, maxProjects: 3, maxAgents: 5, price: '$0' },
  { id: 'tier-2', name: 'Starter', tier: 'starter', maxCalls: 100, windowSeconds: 300, maxTokens: 1000000, maxProjects: 10, maxAgents: 20, price: '$29/mo' },
  { id: 'tier-3', name: 'Pro', tier: 'pro', maxCalls: 500, windowSeconds: 300, maxTokens: 10000000, maxProjects: 50, maxAgents: 100, price: '$99/mo' },
  { id: 'tier-4', name: 'Enterprise', tier: 'enterprise', maxCalls: 999999, windowSeconds: 300, maxTokens: 999999999, maxProjects: 999, maxAgents: 999, price: '$299/mo' },
]
