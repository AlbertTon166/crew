...
export default function Agents() {
  ...
  const { agents: storeAgents, setAgents } = useDashboardStore()
  ...
  // Default mock agents for this page
  const defaultAgents = [
    { id: '1', name: 'Planner Agent', role: 'planner' as const, status: 'online' as const, modelProvider: 'openai', modelName: 'gpt-4', systemPrompt: '', skills: [], enabled: true, projectCount: 3, avgCompleteTime: '2.5天', totalTokens: 1250000, createdAt: '2026-03-01', runningDays: 18 },
    { id: '2', name: 'Frontend Developer', role: 'frontend' as const, status: 'busy' as const, modelProvider: 'anthropic', modelName: 'claude-3', systemPrompt: '', skills: [], enabled: true, projectCount: 2, avgCompleteTime: '3.2天', totalTokens: 890000, createdAt: '2026-03-05', runningDays: 14 },
    { id: '3', name: 'Backend Developer', role: 'backend' as const, status: 'online' as const, modelProvider: 'anthropic', modelName: 'claude-3', systemPrompt: '', skills: [], enabled: true, projectCount: 2, avgCompleteTime: '2.8天', totalTokens: 1100000, createdAt: '2026-03-03', runningDays: 16 },
    { id: '4', name: 'Reviewer Agent', role: 'reviewer' as const, status: 'error' as const, modelProvider: 'anthropic', modelName: 'claude-3', systemPrompt: '', skills: [], enabled: true, projectCount: 4, avgCompleteTime: '1.5天', totalTokens: 560000, createdAt: '2026-03-08', runningDays: 11 },
    { id: '5', name: 'Tester Agent', role: 'tester' as const, status: 'offline' as const, modelProvider: 'openai', modelName: 'gpt-4', systemPrompt: '', skills: [], enabled: false, projectCount: 1, avgCompleteTime: '4.0天', totalTokens: 320000, createdAt: '2026-03-10', runningDays: 9 },
  ]
            ...
            <div key={agent.id} className="card animate-slide-up" style={{ padding: '24px', animationDelay: `${0.1 + index * 0.05}s` }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 12px', borderRadius: '10px', background: 'var(--bg-tertiary)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '12px', fontWeight: '700', color: 'var(--text-primary)' }}>{agent.projectCount}</div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 12px', borderRadius: '10px', background: 'var(--bg-tertiary)' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '12px', fontWeight: '700', color: 'var(--text-primary)' }}>{agent.runningDays}</div>
